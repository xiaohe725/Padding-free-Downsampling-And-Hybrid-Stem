...
class StemBlock(nn.Module):
    def __init__(self, inp=3, num_init_features=32):
        ...
        self.stem_1 = ConvBlock(inp, num_init_features, 3, 1, 1,activation="hswish")
        self.stem_1_1 = ConvBlock(num_init_features, num_init_features, 3, 1, 1,groups=num_init_features,activation="hswish")
        #self.stem_1_2 = ConvBlock(num_init_features, num_init_features, 1, 1, 0,activation="hswish")
        ...
        self.stem_3 = ConvBlock(num_init_features * 2, num_init_features, 1, 1, 0,activation="hswish")

    def forward(self, x):
        stem_1_out = self.stem_1(x)
        stem_2b_out = self.stem_1_1(stem_1_out)
        #stem_2b_out = self.stem_1_2(stem_2b_out)
