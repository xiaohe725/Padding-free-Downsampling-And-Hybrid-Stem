...
class StemBlock(nn.Module):
    def __init__(self, inp=3, num_init_features=32):
        ...
        self.stem_1 = ConvBNActivation2(inp, num_init_features, 3, 2, 1)
        self.stem_1_1 = ConvBNActivation2(num_init_features, num_init_features, 3, 1,groups=num_init_features)
        ...
        self.stem_3 = ConvBNActivation2(num_init_features * 2, num_init_features, 1, 1)
...
class ParC_MobileNetV2(nn.Module):
    def __init__(
        ...
        features: List[nn.Module] = [StemBlock(3, input_channel)]
